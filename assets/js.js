	    ...
	    x = { pos: "bottom", size_indicator: 8, language: "zh_cn", cache: {}, types: ["ships", "equipments"], filters: [], countdown_fade: 250, init: function init() {
			if (this.is_init) return this;this.body = e("div"), c(this.body, "kctip"), this.body.setAttribute("id", "kctip");var t = ["transitionend", "webkitTransitionEnd", "mozTransitionEnd"];t.forEach(function (t) {
				o(this.body, t, function (t) {
					var i = window.getComputedStyle ? getComputedStyle(t.target, null) : t.target.currentStyle;t.currentTarget == t.target && "opacity" == t.propertyName && 0 == i.opacity && x.hideAfter();
				});
			...
			return !m && k && t ? (this.el = t || document.body, (i = this.content(i)) ? (clearTimeout(this.timeout_fade), this.pos = e || this.el.getAttribute("kctip-position") || this.pos, this.init(), r(this.body, "show") || c(this.body, "show"), this.update(i), void (this.is_showing = !0)) : !1) : !1;
		}, position: function position(t) {
			this.body.style.top = "", this.body.style.left = "", this.w = this.body.offsetWidth, this.h = this.body.offsetHeight;var i = this["pos_" + (t || this.pos)](this.w, this.h);i && this.move(i.x, i.y);
		}, hide: function hide(t) {
			function i() {
				p(x.body, "on"), n(x.el, "mousemove", d), x.el = null, x.is_showing = !1, x.pos = "bottom";
			}return this.is_init && this.is_showing ? void ("mouse" == this.pos ? requestAnimationFrame(i) : this.timeout_fade = setTimeout(i, t ? 0 : this.countdown_fade)) : !1;
		}, hideAfter: function hideAfter() {
			p(this.body, "show"), this.body.style.top = "", this.body.style.left = "", this.body.removeAttribute("kctip-indicator-pos"), this.body.removeAttribute("kctip-indicator-offset-x"), this.body.removeAttribute("kctip-indicator-offset-y"), this.body.removeAttribute("kctip-class"), this.container.innerHTML = "", delete this.curLoading, delete this.t, delete this.w, delete this.h, u = null, f = null;
			...
			return this.cache[t] || (this.cache[t] = {}), this.cache[t][this.language] || (this.cache[t][this.language] = {}), this.cache[t][this.language][i] = o, t + "::" + i + "::" + e == this.curLoading ? x.update(o, t) : void 0;
