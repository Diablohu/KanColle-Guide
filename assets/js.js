...
"use strict";var KCTip = (function () {
	function t(t, e) {
		...
		n = !1;var t = document.documentElement.clientWidth,
		    ...
		    r = s + 10 + i,
		    a = c + 25 + o;return r + p.w + 10 > t + i && (r = t + i - p.w - 10), a + p.h + 10 > e + o && (a = e + o - p.h - 10), p.move(r, a);
	}var n = !1,
	    s = void 0,
	    c = void 0,
	    ...
	    d = !1;document.addEventListener("DOMContentLoaded", function () {
		function t(t) {
			a = !0, d = !0;
		}document.body.addEventListener("touchstart", t), document.body.addEventListener("pointerenter", function (e) {
			"touch" == e.pointerType ? t() : (a = !1, d = !1);
		}), document.body.addEventListener("mouseenter", function (t) {
			d ? (d = !1, a = !0) : a = !1;
		});
	});var p = { pos: "bottom", size_indicator: 8, language: "zh_cn", cache: {}, types: ["equipments"], filters: [], countdown_fade: 250, init: function init() {
			if (this.is_init) return this;this.body = document.createElement("div"), this.body.classList.add("kctip"), this.body.setAttribute("id", "kctip");var t = ["transitionend", "webkitTransitionEnd", "mozTransitionEnd"];t.forEach(function (t) {
				this.body.addEventListener(t, function (t) {
					var e = window.getComputedStyle ? getComputedStyle(t.target, null) : t.target.currentStyle;t.currentTarget == t.target && "opacity" == t.propertyName && 0 == e.opacity && p.hideAfter();
				});
			...
			return a || !t ? !1 : (t = t || document.body, this.el = t, (e = this.content(e)) ? (clearTimeout(this.timeout_fade), this.pos = i || t.getAttribute("kctip-position") || this.pos, this.init(), this.body.classList.contains("show") || this.body.classList.add("show"), this.update(e), this.position(i), void (this.is_showing = !0)) : !1);
			...
			function e() {
				p.body.classList.remove("on"), p.el.removeEventListener(i), p.el = null, p.is_showing = !1, p.pos = "bottom";
			...
			return this.cache[t] || (this.cache[t] = {}), this.cache[t][this.language] || (this.cache[t][this.language] = {}), this.cache[t][this.language][e] = o, t + "::" + e + "::" + i == this.curLoading ? p.update(o, t) : void 0;
	    ...
	    h = '[href^="http://fleet.diablohu.com/"], [kctip]',
	    l = document.createEvent("Event"),
	    u = document.createEvent("Event");return l.initEvent("tipshow", !0, !0), u.initEvent("tiphide", !0, !0), document.addEventListener("mouseover", function (e) {
		if (!a) for (var i = e.target; i && i != this; i = i.parentNode) if (t(i, h)) return p.show(i);
	}, !1), document.addEventListener("mouseout", function (e) {
		for (var i = e.target; i && i != this; i = i.parentNode) if (t(i, h)) return p.hide();
	}, !1), document.addEventListener("click", function (e) {
		for (var i = e.target; i && i != this; i = i.parentNode) if (t(i, h)) return p.hide(!0);
	}, !1), document.addEventListener("tipshow", function (e) {
		for (var i = e.target; i && i != this; i = i.parentNode) if (t(i, h)) return p.trigger_by_el(i);
	}, !1), document.addEventListener("tiphide", function (e) {
		for (var i = e.target; i && i != this; i = i.parentNode) if (t(i, h)) return p.hide();
	}, !1), p;
})();